import type { JsonValue, ProtocolErrorCode } from "@lioooooo123/ever-protocol";

export type EverServerOperationErrorCode = Extract<
	ProtocolErrorCode,
...
export class EverServerError extends Error {
	readonly code: EverServerOperationErrorCode;
	readonly details: JsonValue | undefined;

	constructor(code: EverServerOperationErrorCode, message: string, details?: JsonValue) {
		super(message);
...
export class SessionBusyError extends EverServerError {
...
export class SessionLockedError extends EverServerError {
...
export class SessionNotFoundError extends EverServerError {
...
export class NotImplementedError extends EverServerError {
	constructor() {
