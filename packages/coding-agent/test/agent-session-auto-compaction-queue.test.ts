...
import { type AssistantMessage, createAssistantMessageEventStream, fauxAssistantMessage } from "@lioooooo123/ever-ai";
...
describe("AgentSession auto-compaction queue resume", () => {
	...
	beforeEach(async () => {
		tempDir = join(tmpdir(), `ever-auto-compaction-queue-${Date.now()}`);
