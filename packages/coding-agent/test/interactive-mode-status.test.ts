...
import { type AutocompleteProvider, CombinedAutocompleteProvider } from "@lioooooo123/ever-tui";
...
describe("InteractiveMode.showLoadedResources", () => {
	...
	function createExtensionFixtures(): ExtensionFixture[] {
		return [
			{
				path: "/tmp/project/.ever/extensions/answer.ts",
				sourceInfo: createSourceInfo("/tmp/project/.ever/extensions/answer.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.ever/extensions",
				}),
			},
			{
				path: "/tmp/project/.ever/extensions/local-index/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.ever/extensions/local-index/index.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.ever/extensions",
			...
			{
				path: "/tmp/project/.ever/npm/node_modules/ever-markdown-preview/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.ever/npm/node_modules/ever-markdown-preview/extensions/index.ts",
					{
						source: "npm:ever-markdown-preview",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.ever/npm/node_modules/ever-markdown-preview",
					},
				),
			},
			{
				path: "/tmp/project/.ever/npm/node_modules/@scope/ever-scoped/extensions/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.ever/npm/node_modules/@scope/ever-scoped/extensions/index.ts", {
					source: "npm:@scope/ever-scoped",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.ever/npm/node_modules/@scope/ever-scoped",
				}),
			},
			{
				path: "/tmp/project/.ever/git/github.com/HazAT/ever-interactive-subagents/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.ever/git/github.com/HazAT/ever-interactive-subagents/extensions/index.ts",
					{
						source: "git:github.com/HazAT/ever-interactive-subagents",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.ever/git/github.com/HazAT/ever-interactive-subagents",
					},
				),
			},
			{
				path: "/tmp/project/.ever/git/github.com/HazAT/ever-interactive-subagents/extensions/subagents/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.ever/git/github.com/HazAT/ever-interactive-subagents/extensions/subagents/index.ts",
					{
						source: "git:github.com/HazAT/ever-interactive-subagents",
						scope: "project",
						origin: "package",
...
"[Extensions]
  main.ts"`);
	...
	test("package extensions still strip index.ts correctly (regression guard)", () => {
		...
		expect(normalizeRenderedOutput(fakeThis.loadedResourcesContainer)).toMatchInlineSnapshot(`
"[Extensions]
  ever-markdown-preview"`);
	});

	test("labels npm sibling extensions relative to the declaring package", () => {
		const extensions: ExtensionFixture[] = [
			{
				path: "/tmp/project/.ever/npm/node_modules/primary-package/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.ever/npm/node_modules/primary-package/index.ts", {
					source: "npm:primary-package",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.ever/npm/node_modules/primary-package",
				}),
			},
			{
				path: "/tmp/project/.ever/npm/node_modules/sibling-package/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.ever/npm/node_modules/sibling-package/index.ts", {
					source: "npm:primary-package",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.ever/npm/node_modules/primary-package",
...
"[Extensions]
  primary-package, primary-package:../sibling-package"`);
	...
	test("labels Windows npm sibling extensions relative to the declaring package", () => {
		const primaryPath = "C:\\Users\\me\\.ever\\agent\\npm\\node_modules\\primary-package\\index.ts";
		const siblingPath = "C:\\Users\\me\\.ever\\agent\\npm\\node_modules\\sibling-package\\index.ts";
		const baseDir = "C:\\Users\\me\\.ever\\agent\\npm\\node_modules\\primary-package";
		const extensions: ExtensionFixture[] = [
			{
				path: primaryPath,
...
"[Extensions]
  project
    /tmp/project/.ever/extensions/answer.ts
    /tmp/project/.ever/extensions/local-index
    git:github.com/HazAT/ever-interactive-subagents
      extensions
      extensions/subagents
    npm:@scope/ever-scoped
      extensions
    npm:ever-markdown-preview
      extensions
  user
  ...
  path
	...
	test("shows context paths relative to cwd while preserving full external paths", () => {
		const home = homedir();
		const cwd = path.join(home, "Development", "ever-mono");
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			contextFiles: [
				{ path: path.join(home, ".ever", "agent", "AGENTS.md") },
		...
		expect(output).toContain("~/.ever/agent/AGENTS.md, AGENTS.md");
	...
	test("shows system prompt context paths before project context files", () => {
		...
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			systemPromptSource: { path: path.join(cwd, ".ever", "SYSTEM.md") },
			appendSystemPromptSources: [{ path: path.join(cwd, ".ever", "APPEND_SYSTEM.md") }],
		...
		const output = renderAll(fakeThis.loadedResourcesContainer).replace(/\\/g, "/");
		expect(output).toContain("[Context]");
		expect(output).toContain(".ever/SYSTEM.md, .ever/APPEND_SYSTEM.md, AGENTS.md");
	});
	...
	test("shows full context paths when expanded", () => {
		...
		const output = renderAll(fakeThis.loadedResourcesContainer).replace(/\\/g, "/");
		expect(output).toContain("[Context]");
		expect(output).toContain("~/.ever/agent/AGENTS.md");
		expect(output).toContain("~/Development/ever-mono/AGENTS.md");
		expect(output).not.toContain("~/.ever/agent/AGENTS.md, AGENTS.md");
	});
