import { resetCapabilitiesCache, setCapabilities } from "@lioooooo123/ever-tui";
...
describe("theme syntax highlighting", () => {
	...
	it("colors diff additions and deletions in fenced diff blocks", () => {
		...
		expect(lines[0]).toBe("\x1b[38;2;239;111;108m-old\x1b[39m");
		expect(lines[1]).toBe("\x1b[38;2;143;191;159m+new\x1b[39m");
	});
	...
	it("keeps cli-highlight default styled scopes mapped to theme styles", () => {
		...
		expect(highlightCode("@decorator", "python")[0]).toBe("\x1b[38;2;153;145;140m@decorator\x1b[39m");
		expect(highlightCode("<div></div>", "html")[0]).toContain("\x1b[38;2;229;139;114mdiv\x1b[39m");
	});
});
