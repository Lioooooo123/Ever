...
/**
 * Regression test for https://github.com/Lioooooo123/Ever/issues/3303
 *
...
describe("issue #3303 nested .gitignore rules leak into sibling directories", () => {
	...
	describe("flat sibling case", () => {
		beforeEach(() => {
			tempRoot = mkdtempSync(join(tmpdir(), "ever-3303-flat-"));
	...
	describe("deeply nested case", () => {
		beforeEach(() => {
			tempRoot = mkdtempSync(join(tmpdir(), "ever-3303-deep-"));
