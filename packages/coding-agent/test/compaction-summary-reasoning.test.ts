...
import type { AssistantMessage, Model } from "@lioooooo123/ever-ai";
...
vi.mock("@lioooooo123/ever-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@lioooooo123/ever-ai/compat")>();
	return {
		...actual,
