...
| Package | Purpose |
|---------|---------|
| `@lioooooo123/ever` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
...
```typescript
import { isToolCallEventType } from "@lioooooo123/ever";
...
```typescript
import { isBashToolResult } from "@lioooooo123/ever";
...
```typescript
import { createLocalBashOperations } from "@lioooooo123/ever";
...
```typescript
import { SessionManager } from "@lioooooo123/ever";
...
```typescript
import { withFileMutationQueue } from "@lioooooo123/ever";
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@lioooooo123/ever";
...
```typescript
import { keyHint } from "@lioooooo123/ever";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@lioooooo123/ever";
