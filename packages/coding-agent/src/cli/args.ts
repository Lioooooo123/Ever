...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} update [source|self|ever] Update Ever, extensions, or model catalogs
...
${chalk.bold("Options:")}
  ...
  --offline                      Disable startup network operations (same as EVER_OFFLINE=1)
...
${chalk.bold("Environment Variables:")}
  ...
  EVER_PACKAGE_DIR                 - Override package directory (for Nix/Guix store paths)
  EVER_OFFLINE                     - Disable startup network operations when set to 1/true/yes
  EVER_TELEMETRY                   - Override install telemetry when set to 1/true/yes or 0/false/no
  EVER_SHARE_VIEWER_URL            - Optional custom viewer base URL for /share
