import { ProcessTerminal, setKeybindings, type TUI, TuiMainScreen } from "@lioooooo123/ever-tui";
 ...
 * - this is the official Ever distribution (not a fork/rebrand)
 * - experimental features are enabled (EVER_EXPERIMENTAL=1)
