...
import type { AgentMessage, StreamFn } from "@lioooooo123/ever-agent-core";
import type { RetryCallbacks, RetryPolicy } from "@lioooooo123/ever-ai";
import { contentText } from "@lioooooo123/ever-ai";
import type { Model, SimpleStreamOptions, Usage } from "@lioooooo123/ever-ai/compat";
import {
	convertToLlm,
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from Ever-generated summaries (fromHook !== true), not extension-generated ones
