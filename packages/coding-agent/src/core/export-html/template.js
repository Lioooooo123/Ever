    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="ever-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="ever-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'ever-share:v1:sidebar-width';
