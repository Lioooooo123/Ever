...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/Lioooooo123/Ever/releases/latest`;
	}
...
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.EVER_SHARE_VIEWER_URL;
	return baseUrl ? `${baseUrl}#${gistId}` : `https://gist.github.com/${gistId}`;
}

// =============================================================================
// User Config Paths (~/.ever/agent/*)
// =============================================================================
