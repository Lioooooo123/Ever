 ...
 * working indicator shown while ever is streaming a response.
 *
 * Usage:
 *   ever --extension examples/extensions/working-indicator.ts
 *
 * Commands:
...
export default function (ever: ExtensionAPI) {
	...
	ever.registerCommand("working-indicator", {
