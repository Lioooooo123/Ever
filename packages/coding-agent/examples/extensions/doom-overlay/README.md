...
Play DOOM as an overlay in ever. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
ever --extension ./examples/extensions/doom-overlay
```
...
- [ever-doom](https://github.com/Lioooooo123/Ever-doom) for the original upstream integration
