...
import { Editor, type EditorTheme, Key, matchesKey, Text, visibleWidth, wrapTextWithAnsi } from "@lioooooo123/ever-tui";
...
export default function questionnaire(ever: ExtensionAPI) {
	ever.registerTool({
		name: "questionnaire",
		label: "Questionnaire",
		description:
