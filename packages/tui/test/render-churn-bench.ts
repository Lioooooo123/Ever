 ...
 * frames on a layout mirroring Ever's fullscreen interactive mode:
...
async function main(): Promise<void> {
	...
	const tui = new TuiAltScreen(terminal, false, "/tmp/ever-tui-bench");
	...
	const footer = new Text("\x1b[2m~/workspaces/ever  main  100k tokens\x1b[22m", 1, 0);
