...
For non-Windows cross-builds, or for custom Windows toolchains, set `EVER_TUI_WIN32_TOOLCHAIN=mingw` and provide MinGW-compatible compilers:

```sh
EVER_TUI_WIN32_TOOLCHAIN=mingw \
