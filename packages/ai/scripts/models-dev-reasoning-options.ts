...
/**
 * Converts models.dev verified effort values into Ever's selectable thinking levels.
 * Values without a Ever equivalent (`default` and JSON `null`) are intentionally
 * omitted.
 */
