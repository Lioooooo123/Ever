...
const outputPath = join(tmpdir(), "ever-browser-smoke.js");
const agentTreeshakeOutputPath = join(tmpdir(), "ever-agent-treeshake-smoke.js");
const errorLogPath = join(tmpdir(), "ever-browser-smoke-errors.log");
